...
const I18N = {
  zh: {
    ...
    'style.neon': '霓虹肖像', 'style.pop': '波普艺术', 'style.cyber': '赛博朋克', 'style.original': '原图模式',
    'style.vintage': '复古胶片', 'style.thermal': '热成像',
    'style.neon.desc': '高饱和分块 · 赛博潮味',
    'style.pop.desc': '扁平色块 · 海报感', 'style.cyber.desc': '冷色霓虹 + CRT 扫描线',
    'style.vintage.desc': '怀旧 sepia 棕调', 'style.thermal.desc': '红外渐变 · 科技感', 'style.original.desc': '保留真实色彩 · 最自然',
  ...
  en: {
    ...
    'style.neon': 'Neon', 'style.pop': 'Pop', 'style.cyber': 'Cyberpunk', 'style.original': 'Original',
    ...
    'style.vintage.desc': 'Nostalgic sepia tone', 'style.thermal.desc': 'Infrared gradient · tech', 'style.original.desc': 'True colors kept · most natural',
